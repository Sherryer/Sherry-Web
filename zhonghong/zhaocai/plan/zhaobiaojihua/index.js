(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getTemplate_uiControl23: function () {
      var selfTemplate = "import { Backbtn } from 'ysp-custom-components';\n\nmodule.exports = React.createClass({\n  render: function(){\n\n    \n    return (  \n        <Backbtn title=\"\u62DB\u6807\u8BA1\u5212\u53CA\u53D8\u66F4\" describe={{}} />\n\n    )\n  }\n});";
      return "\"use strict\";\n\nvar _yspCustomComponents = require(\"ysp-custom-components\");\n\nmodule.exports = React.createClass({\n  displayName: \"exports\",\n\n  render: function render() {\n\n    return React.createElement(_yspCustomComponents.Backbtn, { title: \"\\u62DB\\u6807\\u8BA1\\u5212\\u53CA\\u53D8\\u66F4\", describe: {} });\n  }\n});";
    },
    getData_control35: function (elem) {
      var trs = elem.querySelectorAll("tr");
      var title = [].slice.call(trs[0].children).map((value, index) => value.textContent);
      title.shift();
      trs = [].slice.call(trs);
      ...
      trs.shift();
      var table = trs.map((value, index) => {
        var tr = [].slice.call(value.children).map((val, ind) => val.textContent);
        return tr;
      });
      var arr1 = [];
    ...
    getTemplate_uiControl61: function () {
      var selfTemplate = "var React = require('react');\n\nmodule.exports = React.createClass({\n  click:function(){\n    let div = this.refs.div;\n    let div1 = this.refs.div1;\n    let icon = this.refs.icon;\n    if(div.style.display == \"none\"){\n    div.style.display = \"block\"\n    div1.style.display = \"none\"\n    icon.style.transform=\"rotate(180deg)\"\n    }else{\n    \tdiv.style.display = \"none\";\n      div1.style.display = \"block\"\n      icon.style.transform=\"\"\n    }\n  },\n  render: function(){\n    var data = this.props.data.customData;  \n      \n    return (\n      <div style={{position:\"relative\",textAlign:\"center\"}}>\n        \n        <div ref = \"icon\" onClick={this.click} style={{padding:\"3px\",right:0,position:\"absolute\",color:\"white\"}}>\n         <span style={{transform:\"scale(0.7)\",color:\"#949494\"}} className=\"icon icon-down-nav navbar-icon\"></span>\n      \t</div>\n        \n        <div onClick={this.click} className=\"partTitle\">\n          \u62DB\u6807\u5C0F\u7EC4\u6210\u5458\n        </div>\n        \n        <div className=\"partBody\">\n         \n          <div ref=\"div1\" className = \"zhTableCon\">\n            \t<table  className = \"zhTable3\">\n            <thead>\n                <tr>\n                    <td>\u6210\u5458\u59D3\u540D</td>\n                    <td>\u804C\u52A1</td>\n                    <td>\u62C5\u4EFB\u672C\u6B21\u62DB\u6807\u5DE5\u4F5C</td>\n                </tr>\n            </thead>\n            <tbody>\n              {\n              \tdata.data&&data.data.map((value,index)=>{\n                \tif(index<8){\n                  return (\n                    <tr>\n                      {value.map((val,ind)=>{\n                      \treturn <td>{val}</td>\n                      })}\n  \t                </tr>\n                  )}\n                })\n              }\n            </tbody>\n\t\t\t\t\t</table>\n          </div>\n\n          \n          \n          \n          \n          <div ref = \"div\" style= {{display:\"none\"}} >\n          <div style={{overflowX:\"scroll\",padding:\"0 0 10px 0\",margin:\"10px 10px 0 10px\"}}  className = \"zhTableCon\">\n            \t<table style={{width:\"125%\"}} className = \"zhTable2\" dangerouslySetInnerHTML = {{__html:data.tbody}}>\n            \n\t\t\t\t\t\t</table>\n          </div>\n           \n            \n          </div>\n          \n          \n        </div>\n        \n        \n        \n\t\t\t\t\n      </div>\n    )\n  }\n});";
      return "\"use strict\";\n\nvar React = require('react');\n\nmodule.exports = React.createClass({\n  displayName: \"exports\",\n\n  click: function click() {\n    var div = this.refs.div;\n    var div1 = this.refs.div1;\n    var icon = this.refs.icon;\n    if (div.style.display == \"none\") {\n      div.style.display = \"block\";\n      div1.style.display = \"none\";\n      icon.style.transform = \"rotate(180deg)\";\n    } else {\n      div.style.display = \"none\";\n      div1.style.display = \"block\";\n      icon.style.transform = \"\";\n    }\n  },\n  render: function render() {\n    var data = this.props.data.customData;\n\n    return React.createElement(\n      \"div\",\n      { style: { position: \"relative\", textAlign: \"center\" } },\n      React.createElement(\n        \"div\",\n        { ref: \"icon\", onClick: this.click, style: { padding: \"3px\", right: 0, position: \"absolute\", color: \"white\" } },\n        React.createElement(\"span\", { style: { transform: \"scale(0.7)\", color: \"#949494\" }, className: \"icon icon-down-nav navbar-icon\" })\n      ),\n      React.createElement(\n        \"div\",\n        { onClick: this.click, className: \"partTitle\" },\n        \"\\u62DB\\u6807\\u5C0F\\u7EC4\\u6210\\u5458\"\n      ),\n      React.createElement(\n        \"div\",\n        { className: \"partBody\" },\n        React.createElement(\n          \"div\",\n          { ref: \"div1\", className: \"zhTableCon\" },\n          React.createElement(\n            \"table\",\n            { className: \"zhTable3\" },\n            React.createElement(\n              \"thead\",\n              null,\n              React.createElement(\n                \"tr\",\n                null,\n                React.createElement(\n                  \"td\",\n                  null,\n                  \"\\u6210\\u5458\\u59D3\\u540D\"\n                ),\n                React.createElement(\n                  \"td\",\n                  null,\n                  \"\\u804C\\u52A1\"\n                ),\n                React.createElement(\n                  \"td\",\n                  null,\n                  \"\\u62C5\\u4EFB\\u672C\\u6B21\\u62DB\\u6807\\u5DE5\\u4F5C\"\n                )\n              )\n            ),\n            React.createElement(\n              \"tbody\",\n              null,\n              data.data && data.data.map(function (value, index) {\n                if (index < 8) {\n                  return React.createElement(\n                    \"tr\",\n                    null,\n                    value.map(function (val, ind) {\n                      return React.createElement(\n                        \"td\",\n                        null,\n                        val\n                      );\n                    })\n                  );\n                }\n              })\n            )\n          )\n        ),\n        React.createElement(\n          \"div\",\n          { ref: \"div\", style: { display: \"none\" } },\n          React.createElement(\n            \"div\",\n            { style: { overflowX: \"scroll\", padding: \"0 0 10px 0\", margin: \"10px 10px 0 10px\" }, className: \"zhTableCon\" },\n            React.createElement(\"table\", { style: { width: \"125%\" }, className: \"zhTable2\", dangerouslySetInnerHTML: { __html: data.tbody } })\n          )\n        )\n      )\n    );\n  }\n});";
    },
    getData_control37: function (elem) {
      var text = elem.querySelectorAll(".table_fj")[3] && elem.querySelectorAll(".table_fj")[3].querySelector("td") && elem.querySelectorAll(".table_fj")[3].querySelector("td").textContent;
      var table = elem.querySelectorAll(".wd_tablelist03")[0];
      var tr = table.children[0].children;
      var xmmc = tr[0] && tr[0].children[0] && tr[0].children[0].textContent.split("：")[1];
      var zbfs = tr[0] && tr[0].children[1] && tr[0].children[1].textContent.split("：")[1];
      var zbcj = tr[0] && tr[0].children[2] && tr[0].children[2].textContent.split("：")[1];
      var jjfs = tr[1] && tr[1].children[0] && tr[1].children[0].textContent.split("：")[1];
      var jbr = tr[1] && tr[1].children[1] && tr[1].children[1].textContent.split("：")[1];
      var zbfl = tr[1] && tr[1].children[2] && tr[1].children[2].textContent.split("：")[1];
      var zbhf = tr[2] && tr[2].children[0] && tr[2].children[0].textContent.split("：")[1];
      var qukzje = tr[2] && tr[2].children[1] && tr[2].children[1].textContent.split("：")[1];
      var zbgg = tr[3] && tr[3].children[0] && tr[3].children[0].textContent.split("：")[1];
      var url = tr[3] && tr[3].children[1] && tr[3].children[1].textContent.split("：")[1];
      return {
        text: text,
        xmmc: xmmc,
        zbfs: zbfs,
    ...
    getTemplate_uiControl63: function () {
      var selfTemplate = "var React = require('react');\n\nmodule.exports = React.createClass({\n  click:function(){\n    let div = this.refs.div;\n    let div1 = this.refs.div1;\n    let icon = this.refs.icon;\n    if(div.style.display == \"none\"){\n    div.style.display = \"block\"\n    div1.style.display = \"none\"\n    icon.style.transform=\"rotate(180deg)\"\n    }else{\n    \tdiv.style.display = \"none\";\n      div1.style.display = \"block\"\n      icon.style.transform=\"\"\n    }\n  },\n  render: function(){\n    var data = this.props.data.customData;  \n    \n      \n    return (\n      <div style={{position:\"relative\",textAlign:\"center\"}}>\n        \n        <div ref = \"icon\" onClick={this.click} style={{padding:\"3px\",right:0,position:\"absolute\",color:\"white\"}}>\n        <span style={{transform:\"scale(0.7)\",color:\"#949494\"}} className=\"icon icon-down-nav navbar-icon\"></span>\n      \t</div>\n        \n        <div onClick={this.click} className=\"partTitle\">\n          \u5176\u4ED6\u4FE1\u606F\n        </div>\n        \n        <div className=\"partBody\">\n         \n          <div ref=\"div1\" style = {{padding:0}} className = \"zhTableCon\">\n            \n          </div>\n\n          \n          \n          \n          \n          <div ref = \"div\" style= {{display:\"none\"}} >\n          <div className = \"zhTableCon\">\n              <table className = \"zhTable\">\n                  <tbody>\n        <tr>\n            <td>\u9879\u76EE\u540D\u79F0</td>\n            <td>{data.xmmc}</td>\n            <td>\u62DB\u6807\u65B9\u5F0F</td>\n            <td>{data.zbfs}</td>\n        </tr>\n        <tr>\n            <td>\u62DB\u6807\u5C42\u7EA7</td>\n            <td>{data.zbcj}</td>\n            <td>\u62DB\u6807\u5206\u7C7B</td>\n            <td>{data.zbfl}</td>\n        </tr>\n        <tr>\n            <td>\u8BA1\u4EF7\u65B9\u5F0F</td>\n            <td>{data.jjfs}</td>\n            <td>\u7ECF\u529E\u4EBA</td>\n            <td>{data.jbr}</td>\n        </tr>\n        <tr>\n            <td>\u6807\u6BB5\u5212\u5206\u6570\u91CF</td>\n            <td>{data.zbhf}</td>\n            <td>\u7B7E\u7EA6\u63A7\u5236\u91D1\u989D</td>\n            <td>{data.qukzje}</td>\n        </tr>\n\n\n        <tr>\n            <td>\u62DB\u6807\u516C\u544A</td>\n            <td colSpan=\"3\">{data.zbgg}</td>\n        </tr>\n        <tr>\n            <td>\u62DB\u6807\u516C\u544A\u53D1\u5E03\u5730\u5740</td>\n            <td colSpan=\"3\">{data.url&&data.url}</td>\n        </tr>\n        <tr>\n            <td>\u60C5\u51B5\u8BF4\u660E</td>\n            <td colSpan=\"3\">{data.text}</td>\n        </tr>\n\n    </tbody>\n             </table>\n      \t\t</div>\n            \n          </div>\n          \n          \n        </div>\n        \n        \n        \n\t\t\t\t\n      </div>\n    )\n  }\n});";
      return "\"use strict\";\n\nvar React = require('react');\n\nmodule.exports = React.createClass({\n  displayName: \"exports\",\n\n  click: function click() {\n    var div = this.refs.div;\n    var div1 = this.refs.div1;\n    var icon = this.refs.icon;\n    if (div.style.display == \"none\") {\n      div.style.display = \"block\";\n      div1.style.display = \"none\";\n      icon.style.transform = \"rotate(180deg)\";\n    } else {\n      div.style.display = \"none\";\n      div1.style.display = \"block\";\n      icon.style.transform = \"\";\n    }\n  },\n  render: function render() {\n    var data = this.props.data.customData;\n\n    return React.createElement(\n      \"div\",\n      { style: { position: \"relative\", textAlign: \"center\" } },\n      React.createElement(\n        \"div\",\n        { ref: \"icon\", onClick: this.click, style: { padding: \"3px\", right: 0, position: \"absolute\", color: \"white\" } },\n        React.createElement(\"span\", { style: { transform: \"scale(0.7)\", color: \"#949494\" }, className: \"icon icon-down-nav navbar-icon\" })\n      ),\n      React.createElement(\n        \"div\",\n        { onClick: this.click, className: \"partTitle\" },\n        \"\\u5176\\u4ED6\\u4FE1\\u606F\"\n      ),\n      React.createElement(\n        \"div\",\n        { className: \"partBody\" },\n        React.createElement(\"div\", { ref: \"div1\", style: { padding: 0 }, className: \"zhTableCon\" }),\n        React.createElement(\n          \"div\",\n          { ref: \"div\", style: { display: \"none\" } },\n          React.createElement(\n            \"div\",\n            { className: \"zhTableCon\" },\n            React.createElement(\n              \"table\",\n              { className: \"zhTable\" },\n              React.createElement(\n                \"tbody\",\n                null,\n                React.createElement(\n                  \"tr\",\n                  null,\n                  React.createElement(\n                    \"td\",\n                    null,\n                    \"\\u9879\\u76EE\\u540D\\u79F0\"\n                  ),\n                  React.createElement(\n                    \"td\",\n                    null,\n                    data.xmmc\n                  ),\n                  React.createElement(\n                    \"td\",\n                    null,\n                    \"\\u62DB\\u6807\\u65B9\\u5F0F\"\n                  ),\n                  React.createElement(\n                    \"td\",\n                    null,\n                    data.zbfs\n                  )\n                ),\n                React.createElement(\n                  \"tr\",\n                  null,\n                  React.createElement(\n                    \"td\",\n                    null,\n                    \"\\u62DB\\u6807\\u5C42\\u7EA7\"\n                  ),\n                  React.createElement(\n                    \"td\",\n                    null,\n                    data.zbcj\n                  ),\n                  React.createElement(\n                    \"td\",\n                    null,\n                    \"\\u62DB\\u6807\\u5206\\u7C7B\"\n                  ),\n                  React.createElement(\n                    \"td\",\n                    null,\n                    data.zbfl\n                  )\n                ),\n                React.createElement(\n                  \"tr\",\n                  null,\n                  React.createElement(\n                    \"td\",\n                    null,\n                    \"\\u8BA1\\u4EF7\\u65B9\\u5F0F\"\n                  ),\n                  React.createElement(\n                    \"td\",\n                    null,\n                    data.jjfs\n                  ),\n                  React.createElement(\n                    \"td\",\n                    null,\n                    \"\\u7ECF\\u529E\\u4EBA\"\n                  ),\n                  React.createElement(\n                    \"td\",\n                    null,\n                    data.jbr\n                  )\n                ),\n                React.createElement(\n                  \"tr\",\n                  null,\n                  React.createElement(\n                    \"td\",\n                    null,\n                    \"\\u6807\\u6BB5\\u5212\\u5206\\u6570\\u91CF\"\n                  ),\n                  React.createElement(\n                    \"td\",\n                    null,\n                    data.zbhf\n                  ),\n                  React.createElement(\n                    \"td\",\n                    null,\n                    \"\\u7B7E\\u7EA6\\u63A7\\u5236\\u91D1\\u989D\"\n                  ),\n                  React.createElement(\n                    \"td\",\n                    null,\n                    data.qukzje\n                  )\n                ),\n                React.createElement(\n                  \"tr\",\n                  null,\n                  React.createElement(\n                    \"td\",\n                    null,\n                    \"\\u62DB\\u6807\\u516C\\u544A\"\n                  ),\n                  React.createElement(\n                    \"td\",\n                    { colSpan: \"3\" },\n                    data.zbgg\n                  )\n                ),\n                React.createElement(\n                  \"tr\",\n                  null,\n                  React.createElement(\n                    \"td\",\n                    null,\n                    \"\\u62DB\\u6807\\u516C\\u544A\\u53D1\\u5E03\\u5730\\u5740\"\n                  ),\n                  React.createElement(\n                    \"td\",\n                    { colSpan: \"3\" },\n                    data.url && data.url\n                  )\n                ),\n                React.createElement(\n                  \"tr\",\n                  null,\n                  React.createElement(\n                    \"td\",\n                    null,\n                    \"\\u60C5\\u51B5\\u8BF4\\u660E\"\n                  ),\n                  React.createElement(\n                    \"td\",\n                    { colSpan: \"3\" },\n                    data.text\n                  )\n                )\n              )\n            )\n          )\n        )\n      )\n    );\n  }\n});";
    },
    ...
    doAction_uiControl68: function (data, elem) {},
    getTemplate_uiControl68: function () {
    ...
    doAction_uiControl70: function (data, elem) {
    ...
    getTemplate_uiControl70: function () {
    ...
    getData_control41: function (elem) {
      var data = [];
    ...
    doAction_uiControl72: function (data, elem) {},
    getTemplate_uiControl72: function () {
    ...
    getData_control42: function (elem) {
      var arr = [].slice.call(elem.querySelectorAll(".table_fj")).map(function (value, index) {
    ...
    doAction_uiControl74: function (data, elem) {
    ...
    getTemplate_uiControl74: function () {
