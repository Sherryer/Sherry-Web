(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    doAction_uiControl151: function (data, elem) {},
    getTemplate_uiControl151: function () {
    ...
    doAction_uiControl157: function (data, elem) {},
    getTemplate_uiControl157: function () {
    ...
    doAction_uiControl161: function (data, elem) {},
    getTemplate_uiControl161: function () {
      var selfTemplate = "var React = require('react');\n\nmodule.exports = React.createClass({\n  click:function(){\n    let div = this.refs.div;\n    let div1 = this.refs.div1;\n    let icon = this.refs.icon;\n    if(div.style.display == \"none\"){\n    div.style.display = \"block\"\n    div1.style.display = \"none\";\n    icon.style.transform=\"rotate(180deg)\"\n    }else{\n    \tdiv.style.display = \"none\";\n      div1.style.display = \"block\"\n      icon.style.transform=\"\"\n    }\n  },\n\n  render: function(){\n    var data = this.props.data.customData;\n\n    return (\n      <div style={{position:\"relative\",textAlign:\"center\"}}>\n\n        <div ref = \"icon\" onClick={this.click} style={{padding:\"3px\",right:0,position:\"absolute\",color:\"white\"}}>\n          <span style={{transform:\"scale(0.7)\",color:\"#949494\"}} className=\"icon icon-down-nav navbar-icon\"></span>\n      \t</div>\n\n        <div  onClick={this.click} className=\"partTitle\">\n          \u62DB\u6807\u5C0F\u7EC4\u6210\u5458\n        </div>\n\n\n        <div ref = \"div1\" className = \"zhTableCon\">\n        \t<table dangerouslySetInnerHTML={{__html:data}} className = \"xzcy zhTable2\">\n\t\t\t\t\t\t\t\n          </table>\n      \t</div>\n\n\n        <div  style = {{display:\"none\"}} ref = \"div\">\n        \t<div style={{padding:\"10px 0 10px 0\",margin:\"0 10px\",overflowX:\"scroll\"}} className = \"zhTableCon\">\n            <table style={{width:\"450px\"}} dangerouslySetInnerHTML={{__html:data}} className = \"zhTable2\">\n\t\t\t\t\t\t\t\n            </table>\n      \t\t</div>\n        </div>\n\n\n    </div>\n    )\n  }\n});";
      return "\"use strict\";\n\nvar React = require('react');\n\nmodule.exports = React.createClass({\n  displayName: \"exports\",\n\n  click: function click() {\n    var div = this.refs.div;\n    var div1 = this.refs.div1;\n    var icon = this.refs.icon;\n    if (div.style.display == \"none\") {\n      div.style.display = \"block\";\n      div1.style.display = \"none\";\n      icon.style.transform = \"rotate(180deg)\";\n    } else {\n      div.style.display = \"none\";\n      div1.style.display = \"block\";\n      icon.style.transform = \"\";\n    }\n  },\n\n  render: function render() {\n    var data = this.props.data.customData;\n\n    return React.createElement(\n      \"div\",\n      { style: { position: \"relative\", textAlign: \"center\" } },\n      React.createElement(\n        \"div\",\n        { ref: \"icon\", onClick: this.click, style: { padding: \"3px\", right: 0, position: \"absolute\", color: \"white\" } },\n        React.createElement(\"span\", { style: { transform: \"scale(0.7)\", color: \"#949494\" }, className: \"icon icon-down-nav navbar-icon\" })\n      ),\n      React.createElement(\n        \"div\",\n        { onClick: this.click, className: \"partTitle\" },\n        \"\\u62DB\\u6807\\u5C0F\\u7EC4\\u6210\\u5458\"\n      ),\n      React.createElement(\n        \"div\",\n        { ref: \"div1\", className: \"zhTableCon\" },\n        React.createElement(\"table\", { dangerouslySetInnerHTML: { __html: data }, className: \"xzcy zhTable2\" })\n      ),\n      React.createElement(\n        \"div\",\n        { style: { display: \"none\" }, ref: \"div\" },\n        React.createElement(\n          \"div\",\n          { style: { padding: \"10px 0 10px 0\", margin: \"0 10px\", overflowX: \"scroll\" }, className: \"zhTableCon\" },\n          React.createElement(\"table\", { style: { width: \"450px\" }, dangerouslySetInnerHTML: { __html: data }, className: \"zhTable2\" })\n        )\n      )\n    );\n  }\n});";
    }
  });
})(window, ysp);