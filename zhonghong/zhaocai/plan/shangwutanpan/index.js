(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    doAction_uiControl135: function (data, elem) {},
    getTemplate_uiControl135: function () {
      var selfTemplate = "import { Backbtn } from 'ysp-custom-components';\n\nmodule.exports = React.createClass({\n  render: function(){\n\n\n    return (\n        <Backbtn title=\"\u5546\u52A1\u8C08\u5224\" describe={{}} />\n\n    )\n  }\n});";
      return "\"use strict\";\n\nvar _yspCustomComponents = require(\"ysp-custom-components\");\n\nmodule.exports = React.createClass({\n  displayName: \"exports\",\n\n  render: function render() {\n\n    return React.createElement(_yspCustomComponents.Backbtn, { title: \"\\u5546\\u52A1\\u8C08\\u5224\", describe: {} });\n  }\n});";
    },
    getData_control81: function (elem) {
    ...
    doAction_uiControl142: function (data, elem) {},
    getTemplate_uiControl142: function () {
    ...
    getData_control85: function (elem) {
      ...
      [].slice.call(titles).map((value, index) => {
        if (value.textContent.match("授权委托书") !== null || value.textContent.match("洽商纪要") !== null || value.textContent.match("洽商过程的录音") !== null) {
    ...
    getData_control86: function (elem) {
      var table1 = elem.cloneNode(true);
      var table2 = elem.cloneNode(true);
      var title = elem.previousElementSibling.textContent.trim();
      table1.children[0].removeChild(table1.children[0].children[3]);
      table1.children[0].removeChild(table1.children[0].children[3]);
      table1.children[0].removeChild(table1.children[0].children[0]);
      table2.children[0].removeChild(table2.children[0].children[0]);
      table2.children[0].insertBefore(table2.children[0].children[4], table2.children[0].children[2]);
      return {
    ...
    doAction_uiControl147: function (data, elem) {},
    getTemplate_uiControl147: function () {
      var selfTemplate = "var React = require('react');\n\nmodule.exports = React.createClass({\n  componentDidMount (){\n\t\tvar tb = this.refs.tb;\n\n    var tables = tb.querySelectorAll(\"table\");\n \n    [].slice.call(tables).map((value,index)=>{\n      value.className = \"zhTable3\"\n    \tvalue.parentElement.style.padding = 0;\n    });\n    \n    var trs = tables[1].querySelectorAll(\"tr\")\n    trs = Array.from(trs);\n\n    trs.map((value,index)=>{\n      var length = value.children.length-1\n    \tvalue.children[length].colSpan=2;\n    })\n    \n  },\n  click:function(){\n    let div = this.refs.div;\n    let div1 = this.refs.div1;\n    let icon = this.refs.icon;\n    if(div.style.display == \"none\"){\n    div.style.display = \"block\"\n    div1.style.display = \"none\";\n    icon.style.transform=\"rotate(180deg)\"\n    }else{\n    \tdiv.style.display = \"none\";\n      div1.style.display = \"block\"\n      icon.style.transform=\"\"\n    }\n  },\n\n  render: function(){\n    var data = this.props.data.customData;\n\n    return (\n      <div style={{position:\"relative\",textAlign:\"center\"}}>\n\n        <div ref = \"icon\" onClick={this.click} style={{padding:\"3px\",right:0,position:\"absolute\",color:\"white\"}}>\n          <span style={{transform:\"scale(0.7)\",color:\"#949494\"}} className=\"icon icon-down-nav navbar-icon\"></span>\n      \t</div>\n\n        <div  onClick={this.click} className=\"partTitle\">\n          {data.title}\n        </div>\n\n\n        <div ref = \"div1\" className = \"zhTableCon\">\n        <table dangerouslySetInnerHTML={{__html:data.table1}} className = \"special zhTable3\">\n            \n\t\t\t\t\t</table>\n      \t</div>\n\n\n        <div  style = {{display:\"none\"}} ref = \"div\">\n        \t<div style={{padding:\"0 0 10px 0\",margin:\"10px\",overflowX:\"scroll\"}} className = \"zhTableCon\">\n          <table ref=\"tb\" style={{width:\"500px\"}} dangerouslySetInnerHTML={{__html:data.table2}} className = \"special specia2 zhTable3\">\n            \n\t\t\t\t\t</table>\n      \t</div>\n        </div>\n\n\n    </div>\n    )\n  }\n});";
      return "\"use strict\";\n\nvar React = require('react');\n\nmodule.exports = React.createClass({\n  displayName: \"exports\",\n  componentDidMount: function componentDidMount() {\n    var tb = this.refs.tb;\n\n    var tables = tb.querySelectorAll(\"table\");\n\n    [].slice.call(tables).map(function (value, index) {\n      value.className = \"zhTable3\";\n      value.parentElement.style.padding = 0;\n    });\n\n    var trs = tables[1].querySelectorAll(\"tr\");\n    trs = Array.from(trs);\n\n    trs.map(function (value, index) {\n      var length = value.children.length - 1;\n      value.children[length].colSpan = 2;\n    });\n  },\n\n  click: function click() {\n    var div = this.refs.div;\n    var div1 = this.refs.div1;\n    var icon = this.refs.icon;\n    if (div.style.display == \"none\") {\n      div.style.display = \"block\";\n      div1.style.display = \"none\";\n      icon.style.transform = \"rotate(180deg)\";\n    } else {\n      div.style.display = \"none\";\n      div1.style.display = \"block\";\n      icon.style.transform = \"\";\n    }\n  },\n\n  render: function render() {\n    var data = this.props.data.customData;\n\n    return React.createElement(\n      \"div\",\n      { style: { position: \"relative\", textAlign: \"center\" } },\n      React.createElement(\n        \"div\",\n        { ref: \"icon\", onClick: this.click, style: { padding: \"3px\", right: 0, position: \"absolute\", color: \"white\" } },\n        React.createElement(\"span\", { style: { transform: \"scale(0.7)\", color: \"#949494\" }, className: \"icon icon-down-nav navbar-icon\" })\n      ),\n      React.createElement(\n        \"div\",\n        { onClick: this.click, className: \"partTitle\" },\n        data.title\n      ),\n      React.createElement(\n        \"div\",\n        { ref: \"div1\", className: \"zhTableCon\" },\n        React.createElement(\"table\", { dangerouslySetInnerHTML: { __html: data.table1 }, className: \"special zhTable3\" })\n      ),\n      React.createElement(\n        \"div\",\n        { style: { display: \"none\" }, ref: \"div\" },\n        React.createElement(\n          \"div\",\n          { style: { padding: \"0 0 10px 0\", margin: \"10px\", overflowX: \"scroll\" }, className: \"zhTableCon\" },\n          React.createElement(\"table\", { ref: \"tb\", style: { width: \"500px\" }, dangerouslySetInnerHTML: { __html: data.table2 }, className: \"special specia2 zhTable3\" })\n        )\n      )\n    );\n  }\n});";
    }
  });
})(window, ysp);